...
const Video = () => {
  ...
  if (!video) return(<div className="h-screen flex items-center justify-center">
  ...
  return (
    <div className=" flex items-center justify-center h-screen">
      <div className="p-6 bg-gray-800 rounded-lg w-full max-w-2xl mx-auto text-white ">
        <h1 className="text-xl font-semibold text-blue-400 mb-4 text-center">
          {video.originalName}
        </h1>

        <div className=" flex items-center justify-center relative">
          <ReactPlayer url={video.downloadUrl} controls playing={playing} />
